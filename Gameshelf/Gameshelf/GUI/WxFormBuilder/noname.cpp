...
MainFrame::MainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_toggleBtn20 = new wxToggleButton( this, wxID_ANY, wxT("3x3 XO"), wxDefaultPosition, wxSize( 70,35 ), 0 );
	m_toggleBtn20->SetValue( true );
	...
	m_toggleBtn201 = new wxToggleButton( this, wxID_ANY, wxT("5x5 XO"), wxDefaultPosition, wxSize( 70,35 ), 0 );
	...
	m_toggleBtn202 = new wxToggleButton( this, wxID_ANY, wxT("Connect Four"), wxDefaultPosition, wxSize( -1,35 ), 0 );
	...
	m_toggleBtn203 = new wxToggleButton( this, wxID_ANY, wxT("Pyramic XO"), wxDefaultPosition, wxSize( -1,35 ), 0 );
	...
	// Connect Events
	m_toggleBtn20->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::openThree ), NULL, this );
	m_toggleBtn202->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::ConnectInit ), NULL, this );
...
{
	// Disconnect Events
	m_toggleBtn20->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::openThree ), NULL, this );
	m_toggleBtn202->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( MainFrame::ConnectInit ), NULL, this );
...
XO3x3::XO3x3( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	gSizer6->Add( m_toggleBtn11, 0, wxEXPAND, 5 );
...
PyramicTicTac::PyramicTicTac( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	CellNo14 = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer18->Add( CellNo14, 0, wxEXPAND, 5 );
	...
	CellNo11 = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer18->Add( CellNo11, 0, wxEXPAND, 5 );

	CellNo13 = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer18->Add( CellNo13, 0, wxEXPAND, 5 );

	CellNo12 = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer18->Add( CellNo12, 0, wxEXPAND, 5 );
	...
	CellNo10 = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer18->Add( CellNo10, 0, wxEXPAND, 5 );

	CellNo9 = new wxButton( this, wxID_ANY, wxT("MyButton"), wxDefaultPosition, wxDefaultSize, 0 );
	gSizer18->Add( CellNo9, 0, wxEXPAND, 5 );
...
XO5x5::XO5x5( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	gSizer6->Add( CellNo1, 0, wxEXPAND, 5 );
...
Credits::Credits( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_bitmap7 = new wxStaticBitmap( this, wxID_ANY, wxBitmap( wxT("ghassan1.bmp"), wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
	...
	Help->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( Credits::CreditsOnMenuSelection ), this, Credits->GetId());
